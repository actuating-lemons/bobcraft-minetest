-- TODO: massive rewrite -BOB

mobs = {}
function mobs:register_mob(name, def)
	-- First register an egg
	...
	minetest.register_entity(name, {
		...
		on_step = function(self, dtime)
			...
			if self.lifetimer <= 0 and not self.tamed then
				...
				for _,obj in ipairs(minetest.env:get_objects_inside_radius(self.object:get_pos(), 20)) do
			...
			if self.sounds and self.sounds.idle and math.random(1, 100) <= 1 then
				minetest.sound_play(self.sounds.idle, {object = self.object})
			end
